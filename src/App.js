  ...
  return (
    <div className="App">
      <nav className={`navbar ${isScrolled ? "scrolled" : ""}`}>
        <div className="nav-container layout-container">
          <div
            className="nav-logo"
      ...
      <section id="services" className="services section-block">
        <div className="layout-container">
          <div className="section-header">
            ...
            <p>
              Nous prenons en charge l’ensemble de vos installations
              électriques, de la conception à la maintenance. Chaque projet est
              livré avec dossier technique et garanties.
            </p>
          </div>
      ...
      <section id="engagements" className="commitments section-block">
        <div className="layout-container">
          <div className="section-header">
      ...
      <section id="process" className="process section-block">
        <div className="layout-container">
          <div className="section-header">
            ...
            <p>
              Une conduite de travaux structurée pour sécuriser vos
              installations et respecter vos délais.
            </p>
          </div>
      ...
      <section id="zone" className="zone-section section-block">
        <div className="layout-container">
          <div className="section-header">
            <span className="section-eyebrow">Zone d’intervention</span>
            <h2>Basés à Auribail, mobiles sur tout le sud toulousain</h2>
            <p>
              Nous intervenons rapidement sur Auribail et dans un rayon de 50
              km : Cintegabelle, Auterive, Muret, Carbonne, Nailloux, ainsi que
      ...
      <footer className="footer">
        <div className="footer-content layout-container">
